...
if (isset($_POST['save_order'])) {
    ...
    $query = "SELECT * FROM tb_orders WHERE order_id='$order_id'";
    $query_run = mysqli_query($con, $query);
    ...
    $check_query = "SELECT * FROM tb_orders WHERE order_id='$order_id'";
    $check_result = mysqli_query($con, $check_query);

    if (mysqli_num_rows($check_result) > 0) {
        $delete_query = "DELETE FROM tb_orders WHERE order_id='$order_id'";
