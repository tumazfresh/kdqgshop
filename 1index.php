...
<body>        
    <div class="slide">
        <img class="mySlides" src="img/slide.png" width="100%" height="100%" 
            ...
            <div class="bottom-adjuster"><!--bottom-->
                <div class="panel-product"><!--product-->
                                ...
                                <div class="product-image-wrapper zoom-effect">
                                    <div class="single-products">
                                        <div class="productinfo text-center">
                                            ...
                                            <a href="1.php?pid=<?= $fetch_product['id']; ?>" class="btn btn btn-default add-to-cart">View Now</a>
                                        </div>
                    ...
                    ?>
                        ...
                        <div class="see-more"><a href="1ProductCatalog.php" class="readmore"><button>View More Products</button></a></div>
            </div><!--endbottom-->
...
<?php } else { ?>
  <form class="chat-container">
    ...
    <a href=""><button type="button" class="chatbtn" style="background-color: #363636">Chat as a Guest</button></a>
  </form>
<?php } ?>
</div>
