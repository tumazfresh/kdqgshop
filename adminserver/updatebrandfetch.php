...
if ($stmt) {
    ...
    if ($result->num_rows > 0) {
     ...
     <script src="../js/productupdate.js"></script>  
              <form method="POST" action="../adminserver/brandupdateserver.php" enctype="multipart/form-data">
                <div class="modal-body">
                    <div id="errorMessage" class="alert alert-warning d-none">All fields are mandatory.</div>
                    <div class="mb-3">
                         <div class="mb-3">
                        <label for="">Brand Name</label>
                        <input type="text" value="<?php echo $row["brandname"]?>" name="brand_name" class="form-control"  >
                    </div>
