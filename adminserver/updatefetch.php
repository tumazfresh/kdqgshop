...
if ($stmt) {
    ...
    if ($result->num_rows > 0) {
     ...
     <script src="../js/productupdate.js"></script>  
              <form method="POST" action="../adminserver/productupdateserver.php" enctype="multipart/form-data">
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <option value="<?php echo $row["subcategory"]?>" selected><?php echo $row["subcategory"]?></option>
                              <?php 
                      
                    $resultc = mysqli_query($db,"SELECT * FROM subcategory ");
                    ...
                    ?>
                        ...
                        <option value="<?php echo $row["color"]?>" selected> 
                        <?php
                                                 $pidd=$row['id'];
                ...
                ?></option>
                    ...
                    ?>
                        ...
                        <option value="<?php echo $row["memory"]?>" selected>
                                                 <?php
                                                 $pidd=$row['id'];
