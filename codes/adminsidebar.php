<div class="add-products-container min-vh-100">
    <div class="add-products-sidebar">
        <ul>
            ...
            <li><a href="admin_messages_page.php"><i class="fas fa-envelope"></i><span class="label">Messages</span></a></li>
            <li><a href="admin_order_page.php"><i class="fas fa-shopping-cart"></i><span class="label">Orders</span></a></li>
            <li><a href="admin_reports.php"><i class="fas fa-file-alt"></i><span class="label">Sales Reports</span></a></li>
            <li><a href="admin_announcement.php"><i class="fas fa-bullhorn"></i><span class="label">Announcements</span></a></li>
