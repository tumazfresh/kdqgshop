...
$result = mysqli_query($db, "SELECT * FROM tb_brand ORDER BY id ASC LIMIT $start_from, $per_page_record ");
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="search-container">
                                    <form action="../admin/adminbrandsearch.php" method="GET">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div id="alertMessage" class="alert d-none"></div>
              ...
              <form method="POST" action="../adminserver/adminbrandserver.php" enctype="multipart/form-data">
