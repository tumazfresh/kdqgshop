...
$start_from = ($page-1) * $per_page_record;
    ...
    $raw_results = mysqli_query($db, "SELECT * FROM tb_brand WHERE (`brandname` LIKE '%".$query."%') ORDER BY id DESC LIMIT $start_from, $per_page_record ") or die(mysql_error());
    ?>
                ...
                <div class="row justify-content-start">
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <form action="./adminbrandsearch.php" method="GET">
...
?>
    ...
    <nav aria-label="navigation">
        <ul class="pagination justify-content-center">
            <?php
            $query = "SELECT COUNT(*) FROM tb_brand";
            ...
            if($page>=2)
            {
                echo "<li class='page-item'><a href='adminbrandsearch.php?page=".($page-1)."' class='page-link'>Prev </a></li>";
            }
            for ($i=1; $i<=$total_pages; $i++)
            {
                if ($i == $page)
                {
                    $pageLink .="<li class='page-item'><a class='page-link' href='adminbrandsearch.php?page=".$i."'>".$i."</a></li>";
                }
                else
                {
                    $pageLink .="<li class='page-item'><a class='page-link' href='adminbrandsearch.php?page=".$i."'>".$i."</a></li>";
            ...
            if($page<$total_pages)
            {
                echo "<li class='apage-item'><a href='adminbrandsearch.php?page=".($page+1)."' class='page-link'>Next </a></li>";
            }
            ?>
        </ul>
    </nav> 
