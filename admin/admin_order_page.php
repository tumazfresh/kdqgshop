...
<head>
    ...
    <title>Store Admin Orders</title>
...
<div class="add-products-menubar">
    <h1><img src="img/logo.png" alt="Logo" class="logo-img"> KING DEO AND QUEEN GRACE STORE ADMIN DASHBOARD</h1>
      ...
      <div class="col-md-12">
        <div class="card">
          <div class="card-header">
            <h4>ORDER LIST - NOTE: tried to use tb_order instead of tb_orders > changed dbcon to dbconn > got error > will fix later  
