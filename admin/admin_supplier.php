            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">SUPPLIER INTERFACE</h4>
          ...
          <div class="card-body">
            <div class="table-responsive">
              <table id="myTable" class="table table-bordered table-striped">
                <thead>
                  <tr>
                    <th style="width: 5%;">SupplierID</th>
                    <th style="width: 10%;">SupplierName</th>
                    <th style="width: 10%;">Warranty</th>
                    <th style="width: 10%;">Replacement</th>
                    <th style="width: 10%;">DateCreated</th>
                    <th style="width: 16%;">ContactPerson</th>
                ...
                <tbody>
                    ...
                    while ($row = mysqli_fetch_array($result))
                    {
                        ?>
                                        ...
                                        <td>
                                         <button type="button" class="viewProductModalBtn btn btn-info btn-sm" data-toggle="modal" data-target="#veiwModal" data-id="<?php echo $row['SupplierID']; ?>">
       <i class="fas fa-eye"></i> VIEW</button>   
                                            
                                            <button type="button" class="editProductBtn btn btn-success btn-sm" data-toggle="modal" data-target="#editModal" data-id="<?php echo $row['SupplierID']; ?>"><i class="fas fa-edit"></i> UPDATE</button>

                                             <button type="button" data-toggle="modal" data-target="#delModal" data-id="<?php echo $row['SupplierID']; ?>" class="deleteProductBtn btn btn-danger btn-sm"><i class="fas fa-trash-alt"></i> DELETE</button>
                                        </td>
                                    </tr>
